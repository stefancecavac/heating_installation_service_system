    ...
    return (
        <div className='shadow-lg rounded-lg w-8/12 flex m-auto my-20 '>
            <form onSubmit={handleSubmit(onSubmit)} className='p-10 flex flex-col  w-3/6 '>
                <p className='text-textcollor text-4xl mb-10'>Login</p>
                ...
                <p className='text-textcollor flex justify-center '>Dont have account? <Link to='/user/register' className='text-Primary'>Register</Link></p>
